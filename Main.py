...
sessions['mysql_standalone'].exec_command("sudo apt-get update")
stdin, stdout, stderr =sessions['mysql_standalone'].exec_command("sudo git clone https://github.com/OthmanSEBTI/LOG8415_FinalProject.git && sudo bash /home/ubuntu/LOG8415_FinalProject/Proxy_setup.sh ")
print('stdout:', stdout.read())
print('stderr:', stderr.read())
stdin, stdout, stderr =sessions['mysql_standalone'].exec_command("python3 ./LOG8415_FinalProject/Proxy_app.py")
print('stdout:', stdout.read())
print('stderr:', stderr.read())