...
stdin, stdout, stderr =sessions['mysql_cluster_slave1'].exec_command("sudo sysbench  oltp_read_write --num-threads=16 --max-requests=10000 --db-driver=mysql --mysql-host=ec2-54-85-81-113.compute-1.amazonaws.com --mysql-user=myapp2 --mysql-db=sakila --table-size=1000000 --max-requests=1000000  prepare")
print('stdout:', stdout.read())
print('stderr:', stderr.read())
...
stdin, stdout, stderr = sessions['mysql_cluster_slave1'].exec_command("time sudo sysbench  oltp_read_write --num-threads=16 --max-requests=10000 --db-driver=mysql --mysql-host=ec2-54-85-81-113.compute-1.amazonaws.com --mysql-user=myapp2 --mysql-db=sakila --table-size=1000000 --max-requests=1000000  run")
print('stdout:', stdout.read())
print('stderr:', stderr.read())
